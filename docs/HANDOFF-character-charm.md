...
kickoff: docs/KICKOFF-character-charm.md
...
supersedes_in_part: docs/HANDOFF-character-style.md (rig + atlas pipeline stay; look direction changes)
---
...
**Kickoff (paste):** [`docs/KICKOFF-character-charm.md`](./KICKOFF-character-charm.md)
