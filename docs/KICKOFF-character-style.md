...
handoff: docs/HANDOFF-character-style.md
---
...
1. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/HANDOFF-character-style.md
2. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/KICKOFF-character-style.md
...
8. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/HANDOFF-CC.md   (context only — do NOT advance first_mission)
