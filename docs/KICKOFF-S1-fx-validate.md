...
1. docs/HANDOFF-CC.md              (§5i PARTIAL; funded teller; this unit)
2. docs/KICKOFF-S1-fx-validate.md  (this file — learnings + plan)
...
Copy the fenced `MISSION` block above into a new agent session after pointing it at this file and `docs/HANDOFF-CC.md` §5i.
