...
product: Branch-Zero
model: Codex Luna
handoff: docs/HANDOFF-copy-ens-refinement.md
---
...
**Handoff:** [`docs/HANDOFF-copy-ens-refinement.md`](./HANDOFF-copy-ens-refinement.md)
...
1. docs/HANDOFF-copy-ens-refinement.md
2. docs/KICKOFF-copy-ens-refinement.md
...
7. Skim: apps/game/dialogue/*.json · apps/game/scripts/bank_interior.gd plaque() calls · docs/HANDOFF-CC.md freeze notes (do not regress)
