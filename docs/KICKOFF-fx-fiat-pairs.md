...
handoff: docs/HANDOFF-fx-fiat-pairs.md
---
...
Canonical plan: [`docs/HANDOFF-fx-fiat-pairs.md`](./HANDOFF-fx-fiat-pairs.md).
...
1. docs/HANDOFF-fx-fiat-pairs.md   (rates, inventories, scope)
2. docs/KICKOFF-fx-fiat-pairs.md   (this file)
3. docs/UNISWAP.md                 (current WETH path — replace product path)
4. docs/HANDOFF-CC.md              (freeze; FX met; do not regress)
