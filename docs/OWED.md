...
- [ ] **iNPC walk feel (readable gait)** — Follow still reads as a slide; probe shows wiring OK (`root_node=..`, 42/42 tracks) but `GumBot_Walk` leg swing ~2° — Stage A product nits then GameLab re-author — [HANDOFF-inpc-gum-bot-walk-feel.md](./missions/HANDOFF-inpc-gum-bot-walk-feel.md) · [KICKOFF-inpc-gum-bot-walk-feel.md](./missions/KICKOFF-inpc-gum-bot-walk-feel.md)
