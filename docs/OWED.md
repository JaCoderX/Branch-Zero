...
- [x] **iNPC companion follow (Phase 1)** — phone **Follow / Unfollow** while awake; the Gum Bot body trails the player with escort-lite seek on a `CharacterBody3D` (no navmesh bake; slide, no walk clip); Unfollow = Stay; Sleep = home + dormant; never a floor lock — [HANDOFF-inpc-companion-follow.md](./missions/HANDOFF-inpc-companion-follow.md) · [KICKOFF-inpc-companion-follow.md](./missions/KICKOFF-inpc-companion-follow.md) (**Claude Code Fable**; Codex Luna named, not in this session) — **met 2026-09-10**: `inpc.follow` event + `GameState.inpc_following` · `inpc.gd` mover child + seek · phone toggle · headless `run_inpc_walk` 18/18 · **slide accepted for Phase 1**; skinned walk opened as GameLab [ENG-2026-0022](../../GameLab/work/ENG-2026-0022-inpc-gum-bot-walk/) (Codex Luna) — product land only after Yes + separate kickoff
- [ ] **iNPC skinned walk (lab → land)** — GameLab [ENG-2026-0022](../../GameLab/work/ENG-2026-0022-inpc-gum-bot-walk/) must answer Yes (idle + walk on Gum Bot Rig, bank look held); then a Branch-Zero land kickoff swaps the glb and drives clips from `inpc.gd` `_walking` — do not start land while lab is open
