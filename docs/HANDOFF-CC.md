...
**U6 status (2026-09-07): PARTIAL / G7 remains open.** The readback and regressions are live and the target-specific
provision/elevator path is in the product tree. This workspace has no `ARC_DEPLOYER_PK`, `ARC_BROADCASTER_PK`,
`ARC_MANAGER_PK`, `ARC_OWNER_ADDRESS`, or `ARC_RECOVERY_ADDRESS`; Circle faucet funding is reCAPTCHA-gated. Do not
use the ENG-0006 lab key or any Remote/Ganache key. Continuation and exact evidence are in
[`docs/progress/2026-09-07-u6-arc-g7.md`](./progress/2026-09-07-u6-arc-g7.md).
