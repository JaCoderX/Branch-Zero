...
product: Branch-Zero
model: Codex Luna
handoff: docs/HANDOFF-dialogue-box-fit.md
---
...
**Handoff:** [`docs/HANDOFF-dialogue-box-fit.md`](./HANDOFF-dialogue-box-fit.md)
...
1. docs/HANDOFF-dialogue-box-fit.md
2. docs/KICKOFF-dialogue-box-fit.md
3. apps/game/scripts/dialogue_box.gd
4. docs/GAME-DESIGN.md §7 (dialogue UX) if needed
5. docs/HANDOFF-CC.md (do not regress freeze)
