...
kickoff: docs/KICKOFF-kaykit-bank-wardrobe.md
...
supersedes_in_part: docs/HANDOFF-kaykit-artdeco-cast.md — Bob done; open quest is the rest of the cast + cloth language
---
...
**Kickoff (paste):** [`docs/KICKOFF-kaykit-bank-wardrobe.md`](./KICKOFF-kaykit-bank-wardrobe.md)
