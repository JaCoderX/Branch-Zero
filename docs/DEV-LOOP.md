...
| **U7 Feel / ship** | Art, video, submission | G8–G10 | ENG-0008 only if S1; staged art Stage 1–5 **met**; ship reel **met** 2026-09-07 (laptop-local mp4); **now = polish** (local `KICKOFF-U7-polish.md`) then packaging (`KICKOFF-U7-ship-package.md`; [DEMO-SCRIPT.md](./DEMO-SCRIPT.md)) |
