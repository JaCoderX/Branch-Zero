...
| **U5 ENS** | Subname + pay-by-name | G6 | ENG-0007 — **partial** (resolve yes 2026-09-07; mint waits on parent registration) |
| **U6 Arc + manager role** | Elevator wing + runtime role (manager already in U4+ as Priority submitter) | G7 | ENG-0006 |
| **U7 Feel / ship** | Art, video, submission | G8–G10 | ENG-0008 only if S1; early art may start off U4+ via [`KICKOFF-U7-viz.md`](./KICKOFF-U7-viz.md) when scheduled clear of U5 |
