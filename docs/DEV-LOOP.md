...
| **S1 Uniswap v4 FX** | FX Desk: Sepolia quote + guarded UR swap + Kenji viz + `FEEDBACK.md` | K7 | **PARTIAL** 2026-09-08 — pool seeded and quoting live on Sepolia, FX till deployed, desk/bridge/Kenji/board built and green; the guarded swap is **blocked on Sepolia gas** (~0.007 ETH). [UNISWAP.md](./UNISWAP.md) · [`KICKOFF-S1-uniswap-fx.md`](./KICKOFF-S1-uniswap-fx.md) |
