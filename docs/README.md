...
| 19 | [HANDOFF-character-style.md](./HANDOFF-character-style.md) · [KICKOFF-character-style.md](./KICKOFF-character-style.md) | **Parallel art:** cast climb beyond Kenney Blocky (Borderlands-adjacent outline; room stays) — **met** 2026-09-08 |
| 19b | [HANDOFF-character-charm.md](./HANDOFF-character-charm.md) · [KICKOFF-character-charm.md](./KICKOFF-character-charm.md) | **Parallel art:** cast charm — legible faces + expressions, ~5.5-heads proportion, mid-50s dress code, one accent per person (room stays) — Codex Luna / CC |
