...
**Kickoff (paste):** [`docs/KICKOFF-dialogue-box-fit.md`](./KICKOFF-dialogue-box-fit.md)
...
4. Prove with a node that has many choices (Kenji after pair pick with 25/100/250 + Ask why / leave, or any NPC with ≥ 6–8 choices). Capture before/after or note in progress.
