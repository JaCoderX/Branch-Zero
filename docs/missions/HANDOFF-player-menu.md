...
**Addendum (2026-09-13):** Front door **Leave feedback** → X post via bridge `openUrl`; About **Watch the demo** → ETHGlobal showcase. Allowlisted hosts only; no in-canvas video.
