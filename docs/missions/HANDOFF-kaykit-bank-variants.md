...
kickoff: docs/missions/KICKOFF-kaykit-bank-variants.md
...
supersedes_in_part: docs/missions/HANDOFF-character-charm.md (Mad Men wardrobe + Kenney face sheet are no longer the live cast direction)
---
...
**Kickoff (paste):** [`docs/missions/KICKOFF-kaykit-bank-variants.md`](./KICKOFF-kaykit-bank-variants.md)
