...
- **Slide accepted** for Phase 1: the glb is rig-stripped; the body slides with no walk clip. **Principal opened** GameLab [ENG-2026-0022](../../../GameLab/work/ENG-2026-0022-inpc-gum-bot-walk/) (walk-rig) — product land only after lab Yes.
