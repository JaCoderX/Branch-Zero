...
2. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/KICKOFF-U7-viz-stage5.md
...
Staged viz ladder complete (Stages 1–5). Next visual unit: [`docs/missions/KICKOFF-U7-ship-reel.md`](./KICKOFF-U7-ship-reel.md)
