...
kickoff: docs/missions/KICKOFF-character-style.md
baseline: U7 viz Stages 1–6 met (Kenney Blocky cast + atlas); web Compatibility gates green
parallel_to: Load Account (docs/missions/HANDOFF-load-account.md) — do not steal that product mission
---
...
**Kickoff (paste):** [`docs/missions/KICKOFF-character-style.md`](./KICKOFF-character-style.md)
