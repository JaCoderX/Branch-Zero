...
2. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/KICKOFF-U7-viz-stage2.md
...
6. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/KICKOFF-U7-viz.md   (Stage 1 rules still apply except scope)
...
Next art unit: **Stage 3** — [`docs/missions/KICKOFF-U7-viz-stage3.md`](./KICKOFF-U7-viz-stage3.md) (characters). Product
