...
product: Branch-Zero
model: Codex Luna
handoff: docs/missions/HANDOFF-fx-desk-spacing.md
---
...
**What this is:** a **small layout pass** — pull Johnny's FX desk **forward** (west / into the lobby) so staff have real space behind the counter. The alcove currently feels too compact.

**Why:** Principal — FX desk too tight against the east wall.

**Baseline:** Main wing playable. Counter ~x=13.5, Johnny ~14.3. Fiat-pairs unit ([HANDOFF-fx-fiat-pairs.md](./HANDOFF-fx-fiat-pairs.md)) is **separate** (Fable) — do not start tokens/pools here.

**Handoff:** [`docs/missions/HANDOFF-fx-desk-spacing.md`](./HANDOFF-fx-desk-spacing.md)
...
| Customer looks east at Johnny | Keep approach; Johnny yaw still faces lobby |
...
MISSION: Branch Zero — FX desk spacing ONLY. Pull Johnny's FX counter/stool/dealer west (into the lobby) so there is comfortable staff clearance behind the desk. Layout / props only.
Freedom on HOW. No freedom on constraints.

BEFORE CODE — read in order:
1. docs/missions/HANDOFF-fx-desk-spacing.md
2. docs/missions/KICKOFF-fx-desk-spacing.md
...
6. docs/missions/HANDOFF-CC.md   (do not regress freeze)
...
- Pull the desk group west ~0.8–1.5 m (tune by eye). Aim for ≥ ~1 m clear Johnny/stool → east wall.
- Move Johnny with the stool. Keep customer approach looking east; Johnny faces west into lobby.
...
3. Walk or viz: customer two-shot (Johnny + board) + staff-side clearance still.
4. Short WORLD-3D §2 note and/or REFLECTION row. Local progress note if useful. Export/refresh web if needed for :5173.

DoD:
- [ ] Staff strip behind Johnny no longer feels pinched against the east wall
- [ ] Customer can still read the quote board and talk to Johnny from the lobby approach
