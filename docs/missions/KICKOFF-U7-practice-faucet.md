...
1. docs/missions/HANDOFF-CC.md          (current mission; freeze; polish DoD — do not regress)
2. docs/NPCS.md §4.2           (faucet already named)
3. docs/missions/KICKOFF-U7-practice-faucet.md  (this file — semantics locked above)
