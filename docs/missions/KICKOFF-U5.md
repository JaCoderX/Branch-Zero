...
1. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/HANDOFF-CC.md   (§5f; U4+ met; ENG-0007 yes)
...
5. Progress note + REFLECTION; HANDOFF → U6 + docs/missions/KICKOFF-U6.md.
