...
2. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/KICKOFF-U7-viz-stage3.md
...
Next art unit: **Stage 4** — [`docs/missions/KICKOFF-U7-viz-stage4.md`](./KICKOFF-U7-viz-stage4.md) (wall shell). Product
