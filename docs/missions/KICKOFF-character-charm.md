...
handoff: docs/missions/HANDOFF-character-charm.md
---
...
1. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/HANDOFF-character-charm.md   (diagnosis, direction, wardrobe sheet)
2. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/KICKOFF-character-charm.md
3. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/HANDOFF-character-style.md   (§Outcome — the pipeline you inherit)
