...
handoff: docs/missions/HANDOFF-ens-passbook-polish.md
---
...
**Handoff:** [`docs/missions/HANDOFF-ens-passbook-polish.md`](./HANDOFF-ens-passbook-polish.md)
...
(1) Omit unclaimed bank-name noise on passbook, Ash, and Iris (no "not chosen yet").
...
1. docs/missions/HANDOFF-ens-passbook-polish.md
2. docs/missions/KICKOFF-ens-passbook-polish.md
3. docs/missions/HANDOFF-copy-ens-refinement.md (prior met — do not regress)
...
6. docs/missions/HANDOFF-CC.md freeze notes (Priority / Bob / FX / Live-Dev)
...
- Everyday bank words on passbook / Ash / Iris. Protocol only in Ask why.
...
2. Soften unclaimed name: hud passbook omits name row (or soft Petra invite — prefer omit); split/condition Ash has_account and Iris done/loaded so unnamed players never see "not chosen yet".
...
DoD:
- [ ] Unnamed: no "not chosen yet" on Ash / Iris / passbook
...
Principal: mock or Live — open account → glance passbook (no name row) → Petra claim → passbook name + Silver → Gold update → passbook Gold. Ash greeting names the bank name only after claim.
