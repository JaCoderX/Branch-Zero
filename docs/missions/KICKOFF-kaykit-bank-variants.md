...
handoff: docs/missions/HANDOFF-kaykit-bank-variants.md
---
...
1. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/HANDOFF-kaykit-bank-variants.md
2. https://github.com/JaCoderX/Branch-Zero/blob/main/docs/missions/KICKOFF-kaykit-bank-variants.md
...
9. History only (do not revive Mad Men as the live goal):
   docs/missions/HANDOFF-character-charm.md · docs/missions/HANDOFF-character-style.md
